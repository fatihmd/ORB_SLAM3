#!/bin/bash
pathDatasetEuroc='/home/fmd/Datasets/Euroc' #Example, it is necesary to change it by the dataset path
...
#gdb /home/fmd/ORB_SLAM3/Examples/Monocular-Inertial/mono_inertial_euroc
...
./Examples/Monocular-Inertial/mono_inertial_euroc ./Vocabulary/ORBvoc.txt ./Examples/Monocular-Inertial/EuRoC.yaml "$pathDatasetEuroc"/V1_02_MEDIUM ./Examples/Monocular-Inertial/EuRoC_TimeStamps/V102.txt dataset-V102_monoi

echo "Launching V103 with Monocular-Inertial sensor"
./Examples/Monocular-Inertial/mono_inertial_euroc ./Vocabulary/ORBvoc.txt ./Examples/Monocular-Inertial/EuRoC.yaml "$pathDatasetEuroc"/V1_03_DIFFICULT ./Examples/Monocular-Inertial/EuRoC_TimeStamps/V103.txt dataset-V103_monoi
